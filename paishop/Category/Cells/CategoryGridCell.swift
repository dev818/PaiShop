...
class CategoryGridCell: UITableViewCell {
    
    @IBOutlet weak var product1Frame: GradientView!
    @IBOutlet weak var product2Frame: GradientView!
    ...
    func setCellContent(_ vc: CategoryVC, row: Int) {
        self.parentVC = vc
        self.product1 = parentVC.productList[row * 2]
        self.product2 = parentVC.productList[row * 2 + 1]
