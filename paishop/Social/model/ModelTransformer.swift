...
// Converter: convert 1423094023323 microseconds into a few days ago, a few hours ago
let TransformerTimestampToTimeAgo = TransformOf<String, NSNumber>(fromJSON: { (value: NSNumber?) -> String? in
    guard let value = value else {
        return ""
    }
    
    let seconds = Double(truncating: value) / 1000
