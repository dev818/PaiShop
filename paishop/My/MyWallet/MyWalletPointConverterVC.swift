//
//  MyWalletPointConverterVC.swift
//  paishop
//
...
class MyWalletPointConverterVC: UIViewController {
    
    @IBOutlet weak var navBar: NavBar!
    @IBOutlet weak var navBarHeightConstraint: NSLayoutConstraint!    
    @IBOutlet weak var convertBackView: UIView!
    ...
    private func setupUI() {
        convertBackView.dropShadow()
        myPointLabel.text = UserInstance.point!
    }
...
extension MyWalletPointConverterVC: NavBarDelegate {
    func didSelectBack() {
        self.navigationController?.popViewController(animated: true)
    }
}
