...
class MyWalletWithdrawRecordVC: UIViewController {
...
extension MyWalletWithdrawRecordVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            cell.paymentTypeLabel.text = "提现金额"
            return cell
        }
...
extension MyWalletWithdrawRecordVC: NavBarDelegate {
    func didSelectBack() {
