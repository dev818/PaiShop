...
class MyOrderMineTab4VC: UIViewController {
    
    var itemInfo: IndicatorInfo = "Tab4"
...
extension MyOrderMineTab4VC: IndicatorInfoProvider {
...
extension MyOrderMineTab4VC: UITableViewDataSource, UITableViewDelegate {
