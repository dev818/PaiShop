...
class MyOrderMineTab3VC: UIViewController {
    
    var itemInfo: IndicatorInfo = "Tab3"
...
extension MyOrderMineTab3VC: IndicatorInfoProvider {
...
extension MyOrderMineTab3VC: UITableViewDataSource, UITableViewDelegate {
