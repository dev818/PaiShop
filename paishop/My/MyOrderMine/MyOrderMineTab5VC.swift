...
class MyOrderMineTab5VC: UIViewController {
    
    var itemInfo: IndicatorInfo = "Tab5"
...
extension MyOrderMineTab5VC: IndicatorInfoProvider {
...
extension MyOrderMineTab5VC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == self.orderItems.count {
            ...
            cell.setCellContent(self.orderItems[indexPath.row], vc: self)
            return cell
        }
    }
