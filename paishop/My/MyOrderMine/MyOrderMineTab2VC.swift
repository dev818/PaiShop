...
class MyOrderMineTab2VC: UIViewController {
    ...
    @IBOutlet weak var tableView: UITableView! {
        didSet {
            ...
            tableView.ts_registerHeaderFooterNib(MyOrderMineTab2CellHeader.self)
            tableView.ts_registerCellNib(MyOrderMineTab2Cell.self)
        }
    }
    ...
    private func setupTheme() {
        ...
        allCheckBox.onFillColor = MainColors.themeEndColors[selectedTheme]
        allCheckBox.onCheckColor = UIColor.white
    }
 ...
 */
    ...
    func calculateSum() {
        ...
        self.calcButton.setTitle("结算", for: .normal)
    }
    ...
    func deleteSelectedCarts(ids: [Int64]) {
        if !NetworkUtil.isReachable() {
            ProgressHUD.showWarningWithStatus("请检查您的互联网连接")
            return
        }
...
extension MyOrderMineTab2VC: IndicatorInfoProvider {
...
extension MyOrderMineTab2VC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: MyOrderMineTab2Cell = tableView.ts_dequeueReusableCell(MyOrderMineTab2Cell.self)
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let cell: MyOrderMineTab2CellHeader = tableView.ts_dequeueReusableHeaderFooter(MyOrderMineTab2CellHeader.self)
...
extension MyOrderMineTab2VC: BEMCheckBoxDelegate {
